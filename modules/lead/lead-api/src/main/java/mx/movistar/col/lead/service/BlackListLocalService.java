...
/**
 * Provides the local service interface for BlackList. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see BlackListLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BlackListLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BlackListLocalServiceUtil} to access the black list local service. Add custom service methods to <code>mx.movistar.col.lead.service.impl.BlackListLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
