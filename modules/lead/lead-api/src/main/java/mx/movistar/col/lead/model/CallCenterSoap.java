...
/**
 * This class is used by SOAP remote services, specifically {@link mx.movistar.col.lead.service.http.CallCenterServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @generated
 */
@ProviderType
public class CallCenterSoap implements Serializable {

	public static CallCenterSoap toSoapModel(CallCenter model) {
		CallCenterSoap soapModel = new CallCenterSoap();

		soapModel.setUuid(model.getUuid());
		soapModel.setCallCenterId(model.getCallCenterId());
	...
	public static CallCenterSoap[] toSoapModels(CallCenter[] models) {
		CallCenterSoap[] soapModels = new CallCenterSoap[models.length];
	...
	public static CallCenterSoap[][] toSoapModels(CallCenter[][] models) {
		CallCenterSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new CallCenterSoap[models.length][models[0].length];
		}
		else {
			soapModels = new CallCenterSoap[0][0];
		}
	...
	public static CallCenterSoap[] toSoapModels(List<CallCenter> models) {
		List<CallCenterSoap> soapModels = new ArrayList<CallCenterSoap>(
			models.size());

		for (CallCenter model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new CallCenterSoap[soapModels.size()]);
	}

	public CallCenterSoap() {
	}
