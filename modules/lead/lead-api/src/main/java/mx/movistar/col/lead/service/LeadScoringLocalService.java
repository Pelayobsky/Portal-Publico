...
/**
 * Provides the local service interface for LeadScoring. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LeadScoringLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LeadScoringLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LeadScoringLocalServiceUtil} to access the lead scoring local service. Add custom service methods to <code>mx.movistar.col.lead.service.impl.LeadScoringLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public LeadScoring addLeadScoring(LeadScoring leadScoring);
	...
	public LeadScoring createLeadScoring(long leadScoringId);
	...
	public LeadScoring deleteLeadScoring(LeadScoring leadScoring);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public LeadScoring deleteLeadScoring(long leadScoringId)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LeadScoring fetchLeadScoring(long leadScoringId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public LeadScoring getLeadScoring(long leadScoringId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LeadScoring> getLeadScoringByPhoneAndIdLead(
		String phone, long idLead);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<LeadScoring> getLeadScorings(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public LeadScoring updateLeadScoring(LeadScoring leadScoring);
