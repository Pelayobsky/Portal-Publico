...
@Component(
		immediate = true,
		property = {
			"model.class.name=mx.movistar.col.lead.model.CallCenter"
		},
		service = CallCenterPermissionChecker.class 
	)
public class CallCenterPermissionCheckerImpl implements CallCenterPermissionChecker {
	...
	public void check(
		...
		if (!contains(permissionChecker, groupId, callCenterId, actionId)) {
	...
	public boolean contains(
		...
		return (permissionChecker.hasPermission(
			groupId, RESOURCE_NAME, callCenterId, actionId));
	}
