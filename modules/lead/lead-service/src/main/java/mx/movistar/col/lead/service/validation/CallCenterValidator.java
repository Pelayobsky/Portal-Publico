...
import mx.movistar.col.lead.exception.CallCenterValidationException;


public class CallCenterValidator {
	 ...
	 *         <code>false</code>
	 */
	public static boolean isCallCenterValid(
	...
	public static void validate(
		...
		throws CallCenterValidationException {

		List<String> errors = new ArrayList<>();
		if (!isCallCenterValid(titleMap, description, dueDate,parameters, errors)) {
			throw new CallCenterValidationException(errors);
		}
	}
	...
	public static boolean isDescriptionValid(
		...
		if (Validator.isBlank(HtmlUtil.stripHtml(description))) {
			errors.add("error.callCenter-description-empty");
			result = false;
		}
	...
	public static boolean isDueDateValid(
		...
		if (Validator.isNull(dueDate)) {
			errors.add("error.CallCenter-date-empty");
			result = false;
		}
	...
	public static boolean isTitleValid(
		...
		if (MapUtil.isEmpty(titleMap)) {
			errors.add("error.callCenter-title-empty");
			result = false;
		}
		else {
