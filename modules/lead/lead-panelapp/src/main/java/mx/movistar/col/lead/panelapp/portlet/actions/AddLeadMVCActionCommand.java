...
@Component(
		...
		property = {
				...
				"mvc.command.name="+MVCCommandNames.ADD_LEAD
		},
		service = MVCActionCommand.class)
public class AddLeadMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void doProcessAction(
		...
		ServiceContext serviceContext = ServiceContextFactory.getInstance(
			Lead.class.getName(), actionRequest);
	...
	private static final Log _log =
		LogFactoryUtil.getLog(AddLeadMVCActionCommand.class);
