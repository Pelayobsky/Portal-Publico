...
package com.movistar.local.libro.service.persistence;
...
public class LibroUtil {
	...
	public static Libro findByUuid_First(
		...
		throws com.movistar.local.libro.exception.NoSuchLibroException {
